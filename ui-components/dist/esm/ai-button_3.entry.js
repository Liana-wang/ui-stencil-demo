...
const AiInput = class {
  constructor(hostRef) {
    ...
    this.aiPressEnter = createEvent(this, "aiPressEnter", 7);
  ...
  render() {
    ...
    return (h(Host, null, h("span", { class: {
      ...
      } }, this.hasPrefix && h("span", { class: 'input-prefix' }, h("slot", { name: 'prefix' })), renderInput(), this.allowClear && this.value !== '' && h("span", { class: 'input-clear-icon', onClick: this.onClear }, "x"), this.hasSuffix && h("span", { class: 'input-suffix' }, h("slot", { name: 'suffix' })))));
  }
