...
const AiPopover = class {
  constructor(hostRef) {
    ...
    this.didPresent = index.createEvent(this, "aiPopoverDidPresent", 7);
    this.willPresent = index.createEvent(this, "aiPopoverWillPresent", 7);
    this.willDismiss = index.createEvent(this, "aiPopoverWillDismiss", 7);
    this.didDismiss = index.createEvent(this, "aiPopoverDidDismiss", 7);
  ...
  async present() {
    ...
    return overlays.present(this, enterAnimation, this.event);
  }
  async dismiss(data, role) {
    const shouldDismiss = await overlays.dismiss(this, data, role, leaveAnimation, this.event);
    if (shouldDismiss) {
  ...
  onDidDismiss() {
    return overlays.eventMethod(this.el, 'aiPopoverDidDismiss');
  }
  onWillDismiss() {
    return overlays.eventMethod(this.el, 'aiPopoverWillDismiss');
  }
  render() {
    const { onLifecycle } = this;
    return (index.h(index.Host, { style: {
        zIndex: `${20000 + this.overlayIndex}`,
      }, onAiPopoverDidPresent: onLifecycle, onAiPopoverWillPresent: onLifecycle, onAiPopoverWillDismiss: onLifecycle, onAiPopoverDidDismiss: onLifecycle, onAiDismiss: this.onDismiss, onAiBackdropTap: this.onBackdropTap }, index.h("ai-backdrop", { tappable: this.backdropDismiss }), index.h("div", { class: "popover-wrapper ai-overlay-wrapper" }, index.h("div", { class: "popover-arrow" }), index.h("div", { class: "popover-content" }))));
  }
