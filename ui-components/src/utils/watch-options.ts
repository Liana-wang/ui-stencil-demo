export const watchForOptions = (containerEl: HTMLElement, tagName: string, onChange: (el) => void) => {
...
const getSelectedOption = (mutationList: MutationRecord[], tagName: string): any => {
